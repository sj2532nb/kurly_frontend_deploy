...
export default function NoticeViewPageComponent () {
    ...
    const {confirmModalOpen, isConfirmModal, ConfirmModalOkCancelOpen, isConfirmModalOkCancelResult} = React.useContext(ConfirmContext);
    // 관리자 로그인 하면 글쓰기 가능
    ...
    const onClickUpdate=(e)=>{
        e.preventDefault();
        isAdmin?(window.location.pathname = '/notice_update'):(confirmModalOpen('관리자 로그인 해주세요'));
        // 수정페이지로 이동
